...
public class Plugin : LethalAPI.Core.Features.Plugin<Config>
{
    ...
    ///     This is optional. A custom implementation can replace this.
    /// </remarks>
    public static Harmony Harmony => new("com.LethalAPI.Moons");

    /// <inheritdoc />
    public override string Name => "LethalAPI.Moons";

    /// <inheritdoc />
    public override string Description => "Moon-related functionality for LethalAPI";
    ...
    public override void OnEnabled()
    {
        ...
        Instance = this;
        Log.Info($"Started plugin &3LethalAPI.Moons &gv1.0.0 &rby &7LethalAPI Modding Community&r.{(this.Config.Debug ? " [&2Debug&r]" : string.Empty)}");
    }
}